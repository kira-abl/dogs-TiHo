...
console.log(array);
  ...
  console.log(req.body.result.question2[0].name);
    ...
    if (req.body.result.question15 !== undefined) {
      array[1].content = req.body.result.question15[0].content;
        array[1].name = req.body.result.question15[0].name;
      } else  {
        array[1].content = "";
        array[1].name = "";
        array[1].link = "";
      ...
      if (req.body.result.question16 !== undefined) {
        array[2].content = req.body.result.question16[0].content;
          array[2].name = req.body.result.question16[0].name;
        } else  {
          array[2].content = "";
          array[2].name = "";
          array[2].link = "";
